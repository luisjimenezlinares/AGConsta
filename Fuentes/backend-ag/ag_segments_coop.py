...
class AG_segments_coop:
    ...
    """
    def __init__(self, pop_size=100, ngen=200, nespecies=3, ngen_intercambio=20, cxpb=0.2, mutpb=0.1, batch_evaluate=False, batch_size=0.1, verbose=False, multi_jobs=False):
        """
    ...
    def eaSimpleCoop(self, S, toolbox, stats=None, halloffame=None):
        """
        ...
        while g < self.ngen:
            ...
            for i, s in enumerate(species):
                ...
                next_repr[i] = toolbox.get_best(s)[0]
